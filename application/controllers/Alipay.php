...
class Alipay extends CI_Controller {
    ...
    public function pagepay(){
        require_once APPPATH.'third_party/alipay/config.php';
        require_once APPPATH.'third_party/alipay/pagepay/service/AlipayTradeService.php';
        require_once APPPATH.'third_party/alipay/pagepay/buildermodel/AlipayTradePagePayContentBuilder.php';
    ...
    public function return_url(){
        ...
        */
        if($result) {//验证成功
            ...
            $this->load->view('/web/finishOrder',$data);
            $this->_loadFoot();
