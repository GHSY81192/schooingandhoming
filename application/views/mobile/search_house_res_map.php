...
<script type="text/javascript">
		    ...
		    "features": [
		        <?php foreach ($data as $val):?>
		        {
		            "properties": {
						...
						"img_url":"/upload/<?php echo get_filepath_by_route_id($val['id'],$val['index_hot_cover'],2); ?>",
						"id":"<?=$val['id']?>",
						"name_cn":"<?=@$val['location']?>",
						"name_en":"<?=@$val['address']?>",
		            }
		        },
		        <?php endforeach;?>
	...
	//   el.innerHTML =html;
	  ...
	  // create the popup
	  var html = '<div class="img-area text-center" onclick="document.location.href=\'/mobile/common/houseDetail/'+marker.properties.id+'\'">';
