...
<div class="x-body">
    ...
    <xblock>
        ...
        <button class="layui-btn" onclick="question_add('添加夏校','/admin/admin/add_summer_page','1300px','90%')"><i class="layui-icon">&#xe608;</i>添加</button>
    ...
    <table class="layui-table">
        ...
        <?php foreach($data as $item):?>
            <tr>
                ...
                <td ><?=$item['name_en']?></td>
                <td ><?=$item['price']?></td>
                <td ><img src="/upload/summer/<?=$item['img']?>" height="50"></td>

                <td class="td-manage">
                    <a title="编辑" href="javascript:;" onclick="question_edit('编辑','/admin/admin/add_summer_page/<?php echo $item['id'] ?>','','1300px','90%')"
...
<script>
    ...
    function question_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            //发异步删除数据
            $.get('/admin/admin/mysql_delete',{id:id,table:'summer'},function(data){
                if(data.status === 888){
