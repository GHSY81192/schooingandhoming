...
<div class="container-fluid" style="margin-top:60px;">
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal" name="form" role="form" id="form" enctype="multipart/form-data" method="post" action="/admin/admin/submit_school">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="intro" value="<?php echo $school['intro'] ?>">
                    <div class="col-xs-4">
                        <script id="intro" type="text/plain" style="width:1024px;height:500px;"><?php echo $school['intro']?$school['intro']:'' ?></script>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-10">
                        <script id="editor" type="text/plain" style="width:1024px;height:500px;"><?php echo $school['financial_tuition_remark']?$school['financial_tuition_remark']:'' ?></script>
                    </div>
                </div>
                <div class="form-group">
...
<script type="text/javascript">
    ...
    function insert(){
        ...
        UE.getEditor('intro').execCommand('insertHtml', value);
...
//	var financial_tuition_remark= '<?php //echo $school['financial_tuition_remark'] ?>//';
        ue.ready(function() {//编辑器初始化完成再赋值
            ...
            var value2 = $('input[name=intro]').val();
//        ue.setContent();
            ue.execCommand('insertHtml', value);  //赋值给UEditor
            ue.execCommand('intro', value2);  //赋值给UEditor
        });
        ...
        $("#submitForm").click(function(){
            ...
            var intro = UE.getEditor('intro').getContent();
