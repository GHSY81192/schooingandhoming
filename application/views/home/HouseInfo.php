...
<div id="body_box">
    <div class="main_box row">
        <div class="col-md-2 menu-box" style="padding-left: 15px">
            ...
            <?php $this->load->view('home/user_menu',array('active'=>7));?>
                        ...
                        <form id="form4" class="partBG">
                            ...
                            <div class="info_box row" style="margin: 20px 0">
                                <div class="col-md-12">
                                    ...
                                    <input class="info_input_text element" name="student_use" type="text" style="width: 99%" value="<?php echo $data['MisInfo']['student_use']?$data['MisInfo']['student_use']:''?>">
                                </div>
                            </div>
                            <div class="info_box row" style="margin: 20px 0">
                                <div class="col-md-12">
