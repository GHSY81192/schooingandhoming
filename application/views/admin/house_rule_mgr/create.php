<div class="container-fluid" style="margin-top:60px;">
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal" name="form" role="form" id="form" enctype="multipart/form-data" method="post" action="/admin/common/house_rule_create_submit">
            <h2 class="col-xs-offset-1 col-xs-10">添加规则</h2>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-2">
                        <img src="/upload/default/school/default.jpg" style="width:200px;" id="perview_image" class="img-thumbnail" />
                    </div>
                    <div class="col-xs-2">
