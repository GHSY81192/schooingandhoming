...
function edit(id) {
    window.location.href = "/admin/common/city_edit?id=" + id;
}

function create() {
    window.location.href = "/admin/common/city_create?state_id=<?php echo $this->input->get('state_id') ?>";
}

function data_del(obj,id) {

    $.ajax({
        url:"/admin/common/city_del?id="+id,
        dataType:'json',
        type:'GET',
